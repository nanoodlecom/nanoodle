...
> can host anywhere or open from disk. A built-in Examples panel carries nineteen
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. Nineteen workflows are
...
>   on-chain, automatically. None of the nineteen published workflows claims one yet,
...
> editor holds nineteen ready-made graphs, mirrored from an open gallery repo
