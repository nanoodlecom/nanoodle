...
> can host anywhere or open from disk. A built-in Examples panel carries 21
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. 21 workflows are
...
>   on-chain, automatically. None of the 21 published workflows claims one yet,
...
> editor holds 21 ready-made graphs, mirrored from an open gallery repo
