...
> can host anywhere or open from disk. A built-in Examples panel carries sixteen
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. Sixteen workflows are
...
>   on-chain, automatically. None of the sixteen published workflows claims one yet,
...
> editor holds sixteen ready-made graphs, mirrored from an open gallery repo
