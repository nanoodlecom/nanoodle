...
> can host anywhere or open from disk. A built-in Examples panel carries 41
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. 42 workflows are
...
>   on-chain, automatically. None of the 41 published workflows claims one yet,
...
> editor holds 41 ready-made graphs, mirrored from an open gallery repo
