...
> can host anywhere or open from disk. A built-in Examples panel carries 26
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. 26 workflows are
...
>   on-chain, automatically. None of the 26 published workflows claims one yet,
...
> editor holds 26 ready-made graphs, mirrored from an open gallery repo
