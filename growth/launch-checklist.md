...
> can host anywhere or open from disk. A built-in Examples panel carries 36
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. 36 workflows are
...
>   on-chain, automatically. None of the 36 published workflows claims one yet,
...
> editor holds 36 ready-made graphs, mirrored from an open gallery repo
