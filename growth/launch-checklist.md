...
> can host anywhere or open from disk. A built-in Examples panel carries 25
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. 25 workflows are
...
>   on-chain, automatically. None of the 25 published workflows claims one yet,
...
> editor holds 25 ready-made graphs, mirrored from an open gallery repo
