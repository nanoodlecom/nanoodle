...
> can host anywhere or open from disk. A built-in Examples panel carries 29
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. 29 workflows are
...
>   on-chain, automatically. None of the 29 published workflows claims one yet,
...
> editor holds 29 ready-made graphs, mirrored from an open gallery repo
