...
> can host anywhere or open from disk. A built-in Examples panel carries 23
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. 23 workflows are
...
>   on-chain, automatically. None of the 23 published workflows claims one yet,
...
> editor holds 23 ready-made graphs, mirrored from an open gallery repo
