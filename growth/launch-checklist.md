...
> can host anywhere or open from disk. A built-in Examples panel carries 31
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. 31 workflows are
...
>   on-chain, automatically. None of the 31 published workflows claims one yet,
...
> editor holds 31 ready-made graphs, mirrored from an open gallery repo
