...
> can host anywhere or open from disk. A built-in Examples panel carries 28
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. 28 workflows are
...
>   on-chain, automatically. None of the 28 published workflows claims one yet,
...
> editor holds 28 ready-made graphs, mirrored from an open gallery repo
