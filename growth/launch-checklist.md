...
> can host anywhere or open from disk. A built-in Examples panel carries seventeen
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. Seventeen workflows are
...
>   on-chain, automatically. None of the seventeen published workflows claims one yet,
...
> editor holds seventeen ready-made graphs, mirrored from an open gallery repo
