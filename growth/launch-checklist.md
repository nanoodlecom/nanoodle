...
> can host anywhere or open from disk. A built-in Examples panel carries 35
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. 35 workflows are
...
>   on-chain, automatically. None of the 35 published workflows claims one yet,
...
> editor holds 35 ready-made graphs, mirrored from an open gallery repo
