...
> can host anywhere or open from disk. A built-in Examples panel carries 22
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. 22 workflows are
...
>   on-chain, automatically. None of the 22 published workflows claims one yet,
...
> editor holds 22 ready-made graphs, mirrored from an open gallery repo
