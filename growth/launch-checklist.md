...
> can host anywhere or open from disk. A built-in Examples panel carries 33
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. 33 workflows are
...
>   on-chain, automatically. None of the 33 published workflows claims one yet,
...
> editor holds 33 ready-made graphs, mirrored from an open gallery repo
