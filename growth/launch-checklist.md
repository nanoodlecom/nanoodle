...
> can host anywhere or open from disk. A built-in Examples panel carries 39
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. 39 workflows are
...
>   on-chain, automatically. None of the 39 published workflows claims one yet,
...
> editor holds 39 ready-made graphs, mirrored from an open gallery repo
