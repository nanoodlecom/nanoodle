...
> can host anywhere or open from disk. A built-in Examples panel carries thirteen
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. Thirteen workflows are
...
>   on-chain, automatically. None of the thirteen published workflows claims one yet,
...
> editor holds thirteen ready-made graphs, mirrored from an open gallery repo
