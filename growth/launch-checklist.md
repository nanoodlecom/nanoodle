...
> can host anywhere or open from disk. A built-in Examples panel carries 40
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. 40 workflows are
...
>   on-chain, automatically. None of the 40 published workflows claims one yet,
...
> editor holds 40 ready-made graphs, mirrored from an open gallery repo
