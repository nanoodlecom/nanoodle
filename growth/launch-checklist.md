...
> can host anywhere or open from disk. A built-in Examples panel carries 27
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. 27 workflows are
...
>   on-chain, automatically. None of the 27 published workflows claims one yet,
...
> editor holds 27 ready-made graphs, mirrored from an open gallery repo
