...
> can host anywhere or open from disk. A built-in Examples panel carries 37
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. 37 workflows are
...
>   on-chain, automatically. None of the 37 published workflows claims one yet,
...
> editor holds 37 ready-made graphs, mirrored from an open gallery repo
