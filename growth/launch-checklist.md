...
> can host anywhere or open from disk. A built-in Examples panel carries 34
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. 34 workflows are
...
>   on-chain, automatically. None of the 34 published workflows claims one yet,
...
> editor holds 34 ready-made graphs, mirrored from an open gallery repo
