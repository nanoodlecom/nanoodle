...
> can host anywhere or open from disk. A built-in Examples panel carries 24
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. 24 workflows are
...
>   on-chain, automatically. None of the 24 published workflows claims one yet,
...
> editor holds 24 ready-made graphs, mirrored from an open gallery repo
