...
> can host anywhere or open from disk. A built-in Examples panel carries 30
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. 30 workflows are
...
>   on-chain, automatically. None of the 30 published workflows claims one yet,
...
> editor holds 30 ready-made graphs, mirrored from an open gallery repo
