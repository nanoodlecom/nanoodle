...
> can host anywhere or open from disk. A built-in Examples panel carries 43
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. 43 workflows are
...
>   on-chain, automatically. None of the 43 published workflows claims one yet,
...
> editor holds 43 ready-made graphs, mirrored from an open gallery repo
