...
> can host anywhere or open from disk. A built-in Examples panel carries eighteen
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. Eighteen workflows are
...
>   on-chain, automatically. None of the eighteen published workflows claims one yet,
...
> editor holds eighteen ready-made graphs, mirrored from an open gallery repo
