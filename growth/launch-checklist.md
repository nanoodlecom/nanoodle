...
> can host anywhere or open from disk. A built-in Examples panel carries twenty
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. Twenty workflows are
...
>   on-chain, automatically. None of the twenty published workflows claims one yet,
...
> editor holds twenty ready-made graphs, mirrored from an open gallery repo
