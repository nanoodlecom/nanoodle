...
> can host anywhere or open from disk. A built-in Examples panel carries 32
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. 32 workflows are
...
>   on-chain, automatically. None of the 32 published workflows claims one yet,
...
> editor holds 32 ready-made graphs, mirrored from an open gallery repo
