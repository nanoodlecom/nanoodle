...
> can host anywhere or open from disk. A built-in Examples panel carries 38
...
> ```
>
> That is the entire setup. No signup, no API key, no dashboard. 38 workflows are
...
>   on-chain, automatically. None of the 38 published workflows claims one yet,
...
> editor holds 38 ready-made graphs, mirrored from an open gallery repo
