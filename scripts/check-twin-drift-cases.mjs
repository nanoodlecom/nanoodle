...
const CASES = [
  ...
  // ---- the 9 planned extractions of docs/twin-drift.md, deleted from BOTH surfaces ----------
  {
    ...
    // then +3 on play.html's second range after the NODE_WORK leftover-.out join fix;
  ...
  },
  {
    ...
    play: [[7502, 7502]], // twin of index.html resizePlan scale clamp — one-sided deletion
    edits: [
      {
        file: "index.html",
        line: 10502,
