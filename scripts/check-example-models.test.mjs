...
test('preserves FIBO size/model, H3 cinematic still, Omni version and Fable pin regressions', async () => {
  ...
  assert.equal(galleryRegressions([]).length, 4);
  ...
  assert.equal(galleryRegressions(pins).length, 4);
