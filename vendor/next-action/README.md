# vendor/next-action — schema · bake · frequency · ring · cold-start · recipe · learned
...
| · 8 | `recipe.mjs`, `corpus/recipes.json` — partial Examples recipe → “add these 2–3 nodes” chips (`?product=8`); empty canvas stays · 6 |
...
Real-editor soft tips: `editor-surface.mjs` mounts in `index.html` (`?product=1`…`6`, `8`).
...
node scripts/bake-next-action-recipes.mjs
